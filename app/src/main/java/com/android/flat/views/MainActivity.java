package com.android.flat.views;
...
import shadik.com.flatviewlib.FlatView;
import shadik.com.flatviewlib.views.FlatButton;
import shadik.com.flatviewlib.views.FlatCheckBox;
import shadik.com.flatviewlib.views.FlatEditText;
import shadik.com.flatviewlib.views.FlatRadioButton;
import shadik.com.flatviewlib.views.FlatSeekBar;
import shadik.com.flatviewlib.views.FlatTextView;
import shadik.com.flatviewlib.views.FlatToggleButton;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        FlatView.initDefaultValues(this);

        // Default theme should be set before content view is added
        FlatView.setDefaultTheme(APP_THEME);
    ...
    private void initUi() {
        ...
        getSupportActionBar().setBackgroundDrawable(FlatView.getActionBarDrawable(this, APP_THEME, false, 2));
        ...
        spinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ...
                switch (position) {
                    case 0:
                        themeReference = FlatView.SAND;
                        break;
                    case 1:
                        themeReference = FlatView.ORANGE;
                        break;
                    case 2:
                        themeReference = FlatView.CANDY;
                        break;
                    case 3:
                        themeReference = FlatView.BLOSSOM;
                        break;
                    case 4:
                        themeReference = FlatView.GRAPE;
                        break;
                    case 5:
                        themeReference = FlatView.DEEP;
                        break;
                    case 6:
                        themeReference = FlatView.SKY;
                        break;
                    case 7:
                        themeReference = FlatView.GRASS;
                        break;
                    case 8:
                        themeReference = FlatView.DARK;
                        break;
                    case 9:
                        themeReference = FlatView.SNOW;
                        break;
                    case 10:
                        themeReference = FlatView.SEA;
                        break;
                    case 11:
                        themeReference = FlatView.BLOOD;
                        break;
                }
    ...
    private void changeTheme(int colorReference) {
        ...
        getSupportActionBar().setBackgroundDrawable(FlatView.getActionBarDrawable(this, colorReference, false));
