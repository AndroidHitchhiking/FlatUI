package shadik.com.flatviewlib.views;
...
import shadik.com.flatviewlib.Attributes;
import shadik.com.flatviewlib.FlatView;
import shadik.com.flatviewlib.R;

/**
 * Created by skhan4 on 1/27/2016.
 */
public class FlatEditText extends EditText implements Attributes.AttributeChangeListener {
    ...
    private void init(AttributeSet attrs) {
        ...
        if (attrs != null) {
            ...
            hasOwnTextColor = attrs.getAttributeValue(FlatView.androidStyleNameSpace, "textColor") != null;
            hasOwnHintColor = attrs.getAttributeValue(FlatView.androidStyleNameSpace, "textColorHint") != null;
        ...
        if(!this.isInEditMode()) {
            Typeface typeface = FlatView.getFont(getContext(), attributes);
